...
## Model vedu\_g response to community trait metrics
...
Create a function that pulls predicted values and upper and lower
...
loop through models and create a long dataframe that combines predicted
values, upper, and lower confidence intervals for each model
...
Plot hierarchical distance, weighted mean dissimilarity, and nearest
